...
plt.scatter(x,y,label="2019",s=75,c="#6baed6",edgecolors='black',linewidths=1.5,alpha=0.2)
plt.scatter(x2,y2,label="2018",s=50,c="#2171b5",edgecolors='black',linewidths=2.5,alpha=0.9)
plt.xlabel("AY")
plt.ylabel("DERECE")
